...
The Frida patches retain their upstream license, including its exception. See [Frida-COPYING](skills/frida-modified/assets/licenses/Frida-COPYING), [Frida-COPYING.LIB](skills/frida-modified/assets/licenses/Frida-COPYING.LIB), and the original [component notice](licenses/frida-modified/NOTICE.md). Exact upstream commits and patch hashes are recorded in the profile assets.
